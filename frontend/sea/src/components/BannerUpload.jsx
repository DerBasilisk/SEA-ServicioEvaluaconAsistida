...
export default function BannerUpload({ currentBanner }) {
  ...
  return (
    <>
      ...
      {showModal && rawSrc && (
        <div className="fixed inset-0 bg-[--text-primary]/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-[2.5rem] p-8 w-full max-w-2xl shadow-2xl border border-white">
            <h3 className="text-[--text-primary] font-black italic uppercase text-center mb-6">Ajustar Banner</h3>
